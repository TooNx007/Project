    ...
    <div class="container-fluid p-0 d-flex h-100">
        <div id="bdSidebar" class="d-flex flex-column flex-shrink-0 p-3 bg-dark text-white offcanvas-md offcanvas-start" style="width: 280px;">
            ...
            <ul class="mynav nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item mb-1">
                    <a href="admin-address.php" class="active"> <!-- ลิ้งไปหน้า admin-address.php -->
                        <i class="fa-solid fa-building-columns"></i>
                        สถานที่
                    </a>
                </li>
                <li class="nav-item mb-1">
                    <a href="admin-course.php" class=""> <!-- ลิ้งไปหน้า admin-course.php -->
                        <i class="fa-solid fa-book"></i>
                        หลักสูตร
                    </a>
                </li>
                <li class="nav-item mb-1">
                    <a href="admin-postwork.php" class=""> <!-- ลิ้งไปหน้า admin-postwork.php -->
        ...
        <div class="bg-light flex-fill">
            <div class="p-2 d-md-none d-flex text-white bg-dark">
                ...
                <div class="row">
                    <div class="col">
                        <p><?php include 'admin-info-address.php'; ?></p>
                    </div>
                </div>
            </div>
